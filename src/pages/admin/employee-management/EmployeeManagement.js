...
const rows = [
  ...
  createData(11, '#0011', 'Name', 'Công chứng viên', 'Ngoại tuyến', '10.000.000'),
  createData(12, '#0012', 'Name', 'Công chứng viên', 'Ngoại tuyến', '10.000.000'),
...
const iconMap = {
  ...
  [filterList.NotaryPublic]: <DifferenceIcon sx={{ height: '18px', width: '18px' }} />,
        ...
        >
          ...
          >
            ...
            <FilterButton
              clickedButton={filterClicked}
              handleFilter={() => {
                setFilterOption(filterList.NotaryPublic);
                setFilterClicked(filterList.NotaryPublic);
              }}
              option={filterList.NotaryPublic}
              iconMap={iconMap}
            />
            <FilterButton
              clickedButton={filterClicked}
